...
static void smartstreetlight_error_init_maptable(void);
static void smartstreetlight_error_init_widgets(void);
...
{
    smartstreetlight_error_init_maptable();
    smartstreetlight_error_init_widgets();
...
gboolean smartstreetlight_error_check_message_result(GtkWidget *parentWidget, gchar* msg, gint result_code)
{
    ...
    smartstreetlight_error_notifice_run(parentWidget, notifice_content);
...
{
    spl_utils_message_box(GTK_WINDOW(parentWidget), GTK_MESSAGE_WARNING,
