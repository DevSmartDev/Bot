#ifndef SMARTSTREETLIGHT_SCHEDULE_H_INCLUDED
#define SMARTSTREETLIGHT_SCHEDULE_H_INCLUDED
...
typedef enum SPL_PROGRAM_POPUP_MENU_Enum
{
    SPL_PROGRAM_M_ADD = 0,
    SPL_PROGRAM_M_SCHEDULE,
    SPL_PROGRAM_M_REMOVE,

    SPL_PROGRAM_M_NUMBER
} SPL_PROGRAM_POPUP_MENU_Enum;
typedef struct _SplDaySchedule
{
    gint        Id;
    gint        programId;
    gchar       *name;
...
typedef struct _SplDayScheduleItem
{
    gint            Id;
    gint            timeBegin;
    gint            timeOn;
    gint            level;
    SplDaySchedule  *parent;
}SplDayScheduleItem;
typedef struct SPL_PROGRAM_POPUP_MENU
{
    GtkWidget *M_Popup;
    GtkWidget *M_Add;
    GtkWidget *M_Schedule;
    GtkWidget *M_Remove;
}SPL_PROGRAM_POPUP_MENU;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

typedef enum SPL_SCHEDULE_POPUP_Enum
{
    SPL_SCHEDULE_M_ADD = 0,
    SPL_SCHEDULE_M_REMOVE,
    SPL_SCHEDULE_M_SCHEDULE,

    SPL_SCHEDULE_M_NUMBER
} SPL_SCHEDULE_POPUP_Enum;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////


typedef struct SPL_SCHEDULE_DAY_POPUP_MENU
{
    GtkWidget *M_Popup;
    GtkWidget *M_Add;
    GtkWidget *M_Schedule;
    GtkWidget *M_Remove;
}SPL_SCHEDULE_DAY_POPUP_MENU;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

typedef struct SPL_SCHEDULE_LIST_POPUP_MENU
{
    GtkWidget *M_Popup;
    GtkWidget *M_Add;
    GtkWidget *M_Remove;
}SPL_SCHEDULE_LIST_POPUP_MENU;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

typedef struct SPL_SCHEDULE_ITEM_POPUP_MENU
{
    GtkWidget *M_Popup;
    GtkWidget *M_Add;
    GtkWidget *M_Remove;
}SPL_SCHEDULE_ITEM_POPUP_MENU;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

typedef struct SPL_SCHEDULE_LIST_NAME_POPUP_MENU
{
    GtkWidget *M_Popup;
    GtkWidget *M_Add;
    GtkWidget *M_Remove;
}SPL_SCHEDULE_LIST_NAME_POPUP_MENU;


////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

typedef struct SPL_SCHEDULE_LIST_CONTENT_POPUP_MENU
{
    GtkWidget *M_Popup;
    GtkWidget *M_Add;
    GtkWidget *M_Remove;
}SPL_SCHEDULE_LIST_CONTENT_POPUP_MENU;


typedef struct SPL_SCHEDULE_TIME_RANGE
{
    gint schedule_item_min_starttime_value;
    gint schedule_item_max_starttime_value;

    gint schedule_item_count;
}SPL_SCHEDULE_TIME_RANGE;
...
typedef struct SPL_SCHEDULE_ITEM_Widgets
{
...
} SPL_SCHEDULE_ITEM_Widgets;


//extern GtkTreeView *program_tree_view;
//extern GtkListStore *program_list_store;

//extern struct SPL_PROGRAM_POPUP_MENU *program_info_popup_menu;
//extern struct SPL_SCHEDULE_POPUP_MENU *schedule_info_popup_menu;
...
//extern struct SPL_Schedule_Widgets	*schedule_widgets;





typedef struct SPL_PROGRAM_Widgets
{
...
extern struct SPL_PROGRAM_Widgets	*program_widgets;

extern struct SPL_SCHEDULE_ITEM_Widgets	*schedule_item_widgets;
...
void smartstreetlight_program_tree_store_clean(void);

void smartstreetlight_program_fill_infomation(const gchar *program_name, gint program_id, gint zone_id, GtkTreeIter *parent_iter);

void smartstreetlight_program_year_show_specific(gint program_id);


void smartstreetlight_day_schedule_fill_infomation(gint day_schedule_id,
                                                   gint list_schedule_id,
                                                   gint program_id,
                                                   gint month);

void smartstreetlight_schedule_fill_infomation(gint store_index,
...
void smartstreetlight_schedule_name_fill_infomations(GtkTreeIter *parent_iter, gint listschedule_id, gchar *listschedule_name);

void smartstreetlight_schedule_item_fill_infomations(gint listschedule_id, gchar *listschedule_name, gint listschedule_programid);

void smartstreetlight_program_popup_menu_show(GtkTreeView *treeview, GdkEventButton *event, gpointer userdata);

void smartstreetlight_schedule_day_popup_menu_show(GtkTreeView *treeview, GdkEventButton *event, gpointer userdata);

void smartstreetlight_schedule_list_popup_menu_show(GtkTreeView *treeview, GdkEventButton *event, gpointer userdata);

void smartstreetlight_schedule_item_popup_menu_show(GtkTreeView *treeview, GdkEventButton *event, gpointer userdata);

void smartstreetlight_schedule_item_name_popup_menu_show(GtkTreeView *treeview, GdkEventButton *event, gpointer userdata);

void smartstreetlight_schedule_item_content_popup_menu_show(GtkTreeView *treeview, GdkEventButton *event, gpointer userdata);

void smartstreetlight_program_fill_program_of_zone(SplZone *zone, GtkTreeIter *parent);

void smartstreetlight_program_fill_infomation_dcu_list(gchar *dcu_id, gint dcu_status);

void smartstreetlight_program_fill_infomation_lcu_list(gchar *lcu_id, gint lcu_status, gint lcu_mode, GtkTreeIter *parent_iter);
#if 0
...
static gboolean smartstreetlight_schedule_create_new(void);



void smartstreetlight_schedule_liststore_clean(void);

//
//void smartstreetlight_schedule_fill_infomation(gchar *schedule_month,
...
void smartstreetlight_schedule_popup_menu_show(GtkTreeView *treeview, GdkEventButton *event, gpointer userdata);

//void smartstreetlight_program_change(const gchar *dcu_id);

gchar *smartstreetlight_program_get_active_name(void);

void smartstreetlight_program_set_value(gchar *program_name);

#endif // 0

#endif // SMARTSTREETLIGHT_SCHEDULE_H_INCLUDED
