...
/**
* SOME NEW METHODs WHICH SO NEED TO INCREMENT SPEED
*
* AUTHOR : MINH HIEU
*
*/
#define         ZOOM_ACTION                             17
gint            osm_gps_map_get_zoom                    (OsmGpsMap *map);
GSList          *osm_gps_map_get_displayed_images       (OsmGpsMap *map);
